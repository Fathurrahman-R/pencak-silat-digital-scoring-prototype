...
| **Kerangka panitia** | Dibangun ulang. Dua kolom menempel penuh ke tepi layar, dipisahkan satu garis. Bilah atas hanya membawa utilitas aplikasi dan tingginya tetap; jejak, judul, keterangan, dan tombol aksi halaman berdiri di bidang isi. Kaca, latar bersemburat, jarak shell, dan efek material dibuang dari CSS — **nol gradien di seluruh bundel admin** |
...
- **Jejak halaman membungkus jadi dua baris di dalam bilah kepala.** "Kejuaraan > Piala Direktur Politeknik Negeri Pontianak > Rekap & Laporan" tidak muat sebaris dengan empat tombol ekspor dan kolom cari; judul halaman terselip di tengah jejak yang membungkus, dan tinggi bilahnya berubah dari satu layar ke layar berikutnya. Jejak yang membungkus juga memotong "Kejuaraan" bersama nama kejuaraannya, karena flexbox menyusutkan semua butir sebanding lebarnya — padahal yang memakan ruang cuma satu
