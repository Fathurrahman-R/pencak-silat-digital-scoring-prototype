...
| S5 | Sedang | Gelanggang | BHS | Partai yang belum pernah mulai menawarkan "Mulai babak **berikutnya**" (babak `–/3`) | [`silat/operator.blade.php:53`](../resources/views/silat/operator.blade.php) | ✅ Label menyebut nomor babaknya — "Mulai babak 1". |
...
| R4 | Rendah | Gelanggang | JARAK | Panel operator/keberatan menyisakan 30–60% tinggi layar kosong | `silat/operator.blade.php`, `silat/keberatan.blade.php` | ✅ Panel operator memakai `h-dvh`, papan skor mengisi sisa tinggi layar. Panel keberatan terisi papan skor (S12). |
